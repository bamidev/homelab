{
  ...
  auto_freeze = {
    dependencies = ["freezolite" "require-hooks"];
    groups = ["default"];
    platforms = [];
    source = {
      path = gems/auto_freeze;
      type = "path";
    };
    version = "0.2.0";
  };
  ...
  bigdecimal = {
    groups = ["default" "development" "monorepo" "opentelemetry" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  click_house-client = {
    dependencies = ["activerecord" "activesupport" "addressable" "json"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  devise-pbkdf2-encryptable = {
    ...
    platforms = [];
    source = {
      path = vendor/gems/devise-pbkdf2-encryptable;
      type = "path";
    };
    version = "0.0.0";
  };
  ...
  diff_match_patch = {
    ...
    platforms = [];
    source = {
      path = vendor/gems/diff_match_patch;
      type = "path";
    };
    version = "0.1.0";
  };
  ...
  error_tracking_open_api = {
    ...
    platforms = [];
    source = {
      path = gems/error_tracking_open_api;
      type = "path";
    };
    version = "1.0.0";
  };
  ...
  gitlab-active-context = {
    dependencies = ["activerecord" "activesupport" "aws-sdk-core" "connection_pool" "elasticsearch" "faraday-typhoeus" "faraday_middleware-aws-sigv4" "opensearch-ruby" "pg" "zeitwerk"];
    groups = ["default"];
    platforms = [];
    source = {
      path = gems/gitlab-active-context;
      type = "path";
    };
    version = "0.0.1";
  };
  gitlab-backup-cli = {
    dependencies = ["activerecord" "activesupport" "addressable" "bigdecimal" "concurrent-ruby" "faraday" "google-cloud-storage_transfer" "google-protobuf" "googleauth" "grpc" "json" "jwt" "logger" "minitest" "mutex_m" "parallel" "pg" "rack" "rainbow" "rexml" "thor"];
    groups = ["default"];
    platforms = [];
    source = {
      path = gems/gitlab-backup-cli;
      type = "path";
    };
    version = "0.0.1";
  };
  ...
  gitlab-database-data_isolation = {
    ...
    platforms = [];
    source = {
      path = gems/gitlab-database-data_isolation;
      type = "path";
    };
    version = "0.1.0";
  };
  ...
  gitlab-fog-azure-rm = {
    dependencies = ["base64" "faraday" "faraday-follow_redirects" "faraday-net_http_persistent" "fog-core" "fog-json" "mime-types" "net-http-persistent" "nokogiri"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  gitlab-grape-openapi = {
    dependencies = ["grape" "grape-entity" "js_regex"];
    groups = ["default"];
    platforms = [];
    source = {
      path = gems/gitlab-grape-openapi;
      type = "path";
    };
    version = "0.1.0";
  };
  gitlab-housekeeper = {
    dependencies = ["activesupport" "amazing_print" "httparty" "rubocop"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      path = gems/gitlab-housekeeper;
      type = "path";
    };
    version = "0.1.0";
  };
  gitlab-http = {
    dependencies = ["activesupport" "concurrent-ruby" "httparty" "ipaddress" "net-http"];
    groups = ["default"];
    platforms = [];
    source = {
      path = gems/gitlab-http;
      type = "path";
    };
    version = "0.1.0";
  };
  ...
  gitlab-labkit = {
    dependencies = ["actionpack" "activesupport" "google-protobuf" "grpc" "jaeger-client" "json_schemer" "openssl" "opentelemetry-exporter-otlp" "opentelemetry-instrumentation-all" "opentelemetry-sdk" "opentracing" "pg_query" "prometheus-client-mmap" "redis"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  gitlab-rspec = {
    dependencies = ["activerecord" "activesupport" "gitlab_quality-test_tooling" "rspec" "test-prof"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      path = gems/gitlab-rspec;
      type = "path";
    };
    version = "0.1.0";
  };
  ...
  gitlab-safe_request_store = {
    ...
    platforms = [];
    source = {
      path = gems/gitlab-safe_request_store;
      type = "path";
    };
    version = "0.1.0";
  };
  gitlab-schema-validation = {
    ...
    platforms = [];
    source = {
      path = gems/gitlab-schema-validation;
      type = "path";
    };
    version = "0.1.0";
  };
  ...
  gitlab-secret_detection = {
    dependencies = ["grpc" "grpc_reflection" "parallel" "re2" "sentry-ruby" "stackprof" "toml-rb"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  gitlab-security_report_schemas = {
    dependencies = ["activesupport" "json_schemer" "mutex_m"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  gitlab-utils = {
    dependencies = ["actionview" "activesupport" "addressable" "batch-loader" "bigdecimal" "nokogiri" "oj" "rake" "toml-rb" "yajl-ruby"];
    groups = ["monorepo"];
    platforms = [];
    source = {
      path = gems/gitlab-utils;
      type = "path";
    };
    version = "0.2.0";
  };
  ...
  gitlab_quality-test_tooling = {
    dependencies = ["activesupport" "amatch" "fog-google" "gitlab" "http" "http-cookie" "nokogiri" "parallel" "rainbow" "rspec-parameterized" "table_print" "zeitwerk"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  graphql-docs = {
    dependencies = ["commonmarker" "escape_utils" "extended-markdown-filter" "gemoji" "graphql" "html-pipeline" "logger" "ostruct" "sass-embedded"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  js-routes = {
    dependencies = ["railties" "sorbet-runtime"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  license_finder = {
    dependencies = ["csv" "rubyzip" "thor" "tomlrb" "with_env" "xml-simple"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  licensee = {
    dependencies = ["dotenv" "octokit" "reverse_markdown" "thor"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  microsoft_graph_mailer = {
    ...
    platforms = [];
    source = {
      path = vendor/gems/microsoft_graph_mailer;
      type = "path";
    };
    version = "0.1.0";
  };
  ...
  ohai = {
    dependencies = ["base64" "chef-config" "chef-utils" "ffi" "ffi-yajl" "ipaddress" "mixlib-cli" "mixlib-config" "mixlib-log" "mixlib-shellout" "plist" "train-core" "wmi-lite"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  omniauth-gitlab = {
    ...
    platforms = [];
    source = {
      path = vendor/gems/omniauth-gitlab;
      type = "path";
    };
    version = "4.0.0";
  };
  ...
  omniauth-salesforce = {
    ...
    platforms = [];
    source = {
      path = vendor/gems/omniauth-salesforce;
      type = "path";
    };
    version = "1.0.5";
  };
  ...
  omniauth_crowd = {
    ...
    platforms = [];
    source = {
      path = vendor/gems/omniauth_crowd;
      type = "path";
    };
    version = "2.4.0";
  };
  ...
  rb_sys = {
    dependencies = ["json" "rake-compiler-dock"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  state_machines-rspec = {
    dependencies = ["activesupport" "rspec" "state_machines"];
    groups = ["test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
  ...
  undercover = {
    dependencies = ["base64" "benchmark" "bigdecimal" "imagen" "rainbow" "rugged" "simplecov" "simplecov_json_formatter"];
    groups = ["development" "test"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
